    ...
    "trastornos-de-conducta-alimentaria": [
      {
        type: "Anorexia",
        description:
          "Los trastornos de la conducta alimentaria son condiciones de salud mental que afectan la relación de una persona con la comida y la percepción de su imagen corporal. Algunos de los trastornos más comunes incluyen la anorexia nerviosa, la bulimia nerviosa y el trastorno por atracón.",
      },
      {
        type: "Bulimia",
        description:
          "La bulimia nerviosa implica episodios recurrentes de ingesta excesiva de alimentos seguida de comportamientos compensatorios para evitar el aumento de peso, como el vómito autoinducido o el uso excesivo de laxantes. Los síntomas incluyen episodios de atracones, preocupación excesiva por el peso y la forma corporal, y cambios físicos como problemas dentales o gastrointestinales.",
      },
      {
        type: "Trastorno por atracón",
        description:
          "El tratorno por atracón implica episodios recurrentes de ingesta excesiva de alimentos sin los comportamientos compensatorios observador en la bulimia. Los síntomas incluyen incapacidad para detenerse durante el atracón, sentimientos de culpa o disgusto depsués del atracón y preocupacióm constante por el peso y la forma corporal.",
      },
      {
        ...
        subgroups: [
          ...
          },
          {
            ...
            description:
              "Miedo al juicio de los demás sobre la apariencia física, lo que contribuye a la ansiedad social y afecta a la percepción de la imagen corporal.",
          },
        ],
      },
    ],
