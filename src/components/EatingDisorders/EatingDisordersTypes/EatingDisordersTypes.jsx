...
const EatingDisordersTypes = () => {
  ...
  return (
    <div className="eating-disorders-types">
      ...
      <p>
        Estos son solo algunos ejemplos de trastornos relacionados con la
        alimentación y la imagen corporal, cada uno con sus propias
        características y necesidades de tratamiento específicas.
      </p>
    </div>
  );
};
